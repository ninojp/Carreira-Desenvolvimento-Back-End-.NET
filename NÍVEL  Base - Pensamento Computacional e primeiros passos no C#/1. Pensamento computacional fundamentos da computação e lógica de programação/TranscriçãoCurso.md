# Curso Alura - Pensamento computacional fundamentos da computação e lógica de programação

## Aula 1: Mundo da Computação

### Aula 1 - Intrudução - Video 1
...
### Aula 1 - Computação everywhere - Video 2
...
### Aula 1 - Para saber mais: Software e a Economia criativa
...
### Aula 1 - Papel da pessoa desenvolvedora - Video 3
...
### Aula 1 - Pensando de modo computacional - Video 4

Transcrição  
Agora que compreendemos melhor o mundo do software e das soluções computacionais, sabemos que, embora existam hardware e software, atuamos mais fortemente na construção do software. Surge então a pergunta: como transformamos uma ideia, identificamos um problema ou uma demanda do dia a dia, em uma solução por meio de software?

Já destacamos que um computador realiza basicamente operações lógico-aritméticas em seus circuitos eletrônicos. Construir um software significa, essencialmente, instruir o computador sobre como ele deve interagir com a pessoa usuária dentro de uma aplicação. Essas instruções devem ser bem organizadas e claras. Pode surgir a dúvida: como instruímos o computador? Essa é a principal atividade da pessoa desenvolvedora no dia a dia.
...
### Aula 1 - Estruturando dados - Exercício

A Organo, uma plataforma para criação e gestão de organogramas empresariais, está desenvolvendo uma nova funcionalidade que permite às pessoas usuárias criar organogramas dinâmicos que se ajustam automaticamente a mudanças na estrutura organizacional, como promoções ou transferências de funcionários. A equipe de desenvolvimento que você faz parte precisa estruturar os dados de forma que essas mudanças sejam refletidas instantaneamente no organograma.

Qual abordagem seria mais eficiente para estruturar esses dados?
...
> Correta, pois essa abordagem utiliza o pensamento computacional de forma abrangente, decompondo o problema, reconhecendo padrões, abstraindo informações e criando um modelo de dados eficiente, o que é essencial para a atualização dinâmica do organograma.

### Aula 1 - Organizando equipes - Exercício

Uma loja online de roupas e acessórios está desenvolvendo um aplicativo com realidade aumentada para que os clientes visualizem como ficariam usando os produtos antes da compra.

Qual seria a melhor abordagem para integrar as diferentes especialidades da equipe (como desenvolvimento, design, marketing e atendimento ao cliente) e garantir o sucesso do projeto?

Resposta:  
Promover uma colaboração eficaz entre as equipes de design, desenvolvimento de software e marketing, com reuniões regulares e comunicação clara, além de realizar testes de usabilidade para garantir uma experiência intuitiva e envolvente.

> Correta, pois essa abordagem assegura que todas as equipes trabalhem em conjunto para criar um aplicativo de realidade aumentada que seja funcional, atraente e bem comunicado aos clientes, alinhando objetivos e resolvendo problemas rapidamente.

### Aula 1 - Uso intensivo da computação
...
- O conceito de dispositivos computacionais.
- A integração de hardware e software em soluções computacionais.
- As principais divisões de um software: back-end, front-end e banco de dados.
- O papel das equipes de software no desenvolvimento, teste e manutenção de aplicações.
- O conceito de computação pervasiva.
- O conceito de pensamento computacional para resolver problemas de forma lógica.

## Aula 2 - Explorando o pensamento computacional

### Aula 2 - Decompondo problemas - Video 1
